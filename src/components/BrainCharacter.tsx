    ...
    <div className="flex flex-col items-center gap-4 py-8">
      <div className="brain-sway">
        <svg width="160" height="170" viewBox="0 0 160 170" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* Eyes with blink */}
          <g style={{ transform: `scaleY(${eyeScaleY})`, transformOrigin: '65px 72px', transition: 'transform 0.08s ease-in-out' }}>
          ...
          <g style={{ transform: `scaleY(${eyeScaleY})`, transformOrigin: '97px 72px', transition: 'transform 0.08s ease-in-out' }}>
